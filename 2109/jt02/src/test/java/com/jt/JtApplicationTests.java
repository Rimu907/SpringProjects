...
//        List<ItemCat> oneList = itemCatMapper.selectList(wrapper);
//        List<ItemCat> twoList = null;
//        List<ItemCat> twoList1 = null;
//        List<ItemCat> twoList2 = null;
//
//        int i = 0, j = oneList.size()-1, mid = (i+j)/2;
...
//            while (i<mid){
//                wrapper.clear();
//                QueryWrapper<ItemCat> twoIds = wrapper.eq("parent_id", oneList.get(i));
//                twoList1 = itemCatMapper.selectList(twoIds);
//                i++;
//            }
//            while (j>mid){
//                wrapper.clear();
//                QueryWrapper<ItemCat> twoIds = wrapper.eq("parent_id", oneList.get(j));
//                twoList2 = itemCatMapper.selectList(twoIds);
//                j--;
//            }
//        }
